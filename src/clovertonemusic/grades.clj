...
(def html-grades
  {"one" {:title "Grade One - Clovertone Music"
          :contents [:div#contents
                     [:div#content.index
                      [:h1.title "Grade One"]
                      [:p "Our grade 1 selections are for junior high school and advanced elementary school bands in their first years of playing."]]]
          :charts [:div#charts
                   [:div#list
                    [:div#2.chart.grade1
                     [:div.head
   ...
   "two" {:title "Grade Two - Clovertone Music"
          :contents [:div#contents
                     [:div#content.index
                      [:h1.title "Grade Two"]
                      [:p "These grade 2 charts are aimed at intermediate bands or good junior bands."]]]
          :charts [:div#charts
                   [:div#list
                    [:div#7.chart.grade2
                     [:div.head
   ...
   "three" {:title "Grade Three - Clovertone Music"
            :contents [:div#contents
                       [:div#content.index
                        ...
                        [:p "Here you will find senior band charts for players with a few years of experience."]]]
            :charts [:div#charts
                     [:div#list
                      [:div#3.chart.grade3
                       [:div.head
   ...
   "four" {:title "asdasd"
           :contents [:div#contents
                      [:div#content.index
                       [:h1.title "Grade Four"]
                       [:p "This is where you will find all of our advanced material written at professional level directed towards university bands or strong arts focused high schools. "]]]
           :charts [:div#charts
                    [:div#list
                     [:div#16.chart.grade4
                      [:div.head
