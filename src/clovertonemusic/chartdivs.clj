...
(defn chart
  [number grade-number grade-name chart-path chart-name composer-path composer-name price
   category audio-path preview-path purchase-email customized-email chart-notes chart-details]
...
(def o-canada
  (chart 2 1 "Grade 1" "/charts/o-canada" "O Canada" "/composers/christian-overton"
         ...
         "/previews/o-canada.preview.pdf" "O%20Canada"
         "O%20Canada"
         [:div.notes
          [:p
...
(def sock-hop-be-bop
  (chart 4 1 "Grade 1" "/charts/sock-hop-be-bop" "Sock Hop Be-Bop" "/composers/christian-overton"
         ...
         "/previews/sock-hop-be-bop.preview.pdf" "Sock%20Hop%20Be-Bop"
         "Sock%20Hop%20Be-Bop"
         [:div.notes
          [:p
...
(def tango
  (chart 5 1 "Grade 1" "/charts/tango" "Tango!" "/composers/christian-overton"
         ...
         "/previews/tango.preview.pdf" "%20the%20chartTango!"
         "Tango!"
         [:div.notes
          [:p
...
(def sakura-lullaby
  (chart 6 1 "Grade 1" "/charts/sakura-lullaby" "Sakura Lullaby" "/composers/christian-overton"
         ...
         "/previews/sakura-lullaby.preview.pdf" "Sakura%20Lullaby"
         "Sakura%20Lullaby"
         [:div.notes
          [:p
...
(def game-on
  (chart 11 1 "Grade 1" "/charts/game-on" "Game On!" "/composers/andy-ballantyne"
         ...
         "/previews/game-on.preview.pdf" "Game%20On!"
         "Game%20On!"
         [:div.notes
          [:p
...
(def at-long-last
  (chart 27 1 "Grade 1" "/charts/at-long-last" "At Long Last" "/composers/christian-overton"
         ...
         "/previews/at-long-last.preview.pdf" "At%20Long%20Last"
         "At%20Long%20Last"
         [:div.notes
          [:p
...
(def hotel-mambo
  (chart 29 1 "Grade 1" "/charts/hotel-mambo" "Hotel Mambo" "/composers/christian-overton"
         ...
         "/previews/hotel-mambo.preview.pdf" "Hotel%20Mambo"
         "Hotel%20Mambo"
         [:div.notes
          [:p
...
(def petes-chune
  (chart 30 1 "Grade 1" "/charts/petes-chune" "Pete's Chune" "/composers/christian-overton"
         ...
         "/previews/petes-chune.preview.pdf" "Pete's%20Chune"
         "Pete's%20Chune"
         [:div.notes
          [:p
...
(def train-track
  (chart 32 1 "Grade 1" "/charts/train-track" "Train Track" "/composers/christian-overton"
         ...
         "/previews/train-track.preview.pdf" "Train%20Track"
         "Train%20Track"
         [:div.notes
          [:p
...
(def all-your-base
  (chart 35 1 "Grade 1" "/charts/all-your-base" "All Your Base" "/composers/erik-patterson"
         ...
         "/previews/all-your-base.preview.pdf" "All%20Your%20Base"
         "All%20Your%20Base"
         [:div.notes
          [:p
...
(def shuswap-shuffle
  (chart 36 1 "Grade 1" "/charts/shuswap-shuffle" "Shuswap Shuffle" "/composers/andy-ballantyne"
         ...
         "/previews/shuswap-shuffle.preview.pdf" "Shuswap%20Shuffle"
         "Shuswap%20Shuffle"
         [:div.notes
          [:p
...
(def red-river-mud-pie
  (chart 37 1 "Grade 1" "/charts/red-river-mud-pie" "Red River Mud Pie" "/composers/andy-ballantyne"
         ...
         "/previews/red-river-mud-pie.preview.pdf" "Red%20River%20Mud%20Pie"
         "Red%20River%20Mud%20Pie"
         [:div.notes
          [:p
...
(def gentlemen
  (chart 60 1 "Grade 1" "/charts/gentlemen" "Gentlemen" "/composers/erik-patterson"
         ...
         "/previews/gentlemen.preview.pdf" "Gentlemen"
         "Gentlemen"
         [:div.notes
          [:p
...
(def la-cattura
  (chart 61 1 "Grade 1" "/charts/la-cattura" "La Cattura Di Salvatore Veloce" "/composers/erik-patterson"
         ...
         "/previews/la-cattura.preview.pdf" "La%20Cattura%20Di%20Salvatore%20Veloce"
         "La%20Cattura%20Di%20Salvatore%20Veloce"
         [:div.notes
          [:p
...
(def cowboy-countdown
  (chart 65 1 "Grade 1" "/charts/cowboy-countdown" "Cowboy Countdown" "/composers/christian-overton"
         ...
         "/previews/cowboy-countdown.preview.pdf" "Cowboy%20Countdown"
         "Cowboy%20Countdown"
         [:div.notes
          [:p
...
(def la-squadra-da-milano
  (chart 75 1 "Grade 1" "/charts/la-squadra-da-milano" "La Squadra Da Milano" "/composers/erik-patterson"
         ...
         "/previews/la-squadra-da-milano.preview.pdf" "La%20Squadra%20Da%20Milano"
         "La%20Squadra%20Da%20Milano"
         [:div.notes
          [:p
...
(def stone-cold-strut
  (chart 76 1 "Grade 1" "/charts/stone-cold-strut" "Stone Cold Strut" "/composers/erik-patterson"
         ...
         "/previews/stone-cold-strut.preview.pdf" "Stone%20Cold%20Strut"
         "Stone%20Cold%20Strut"
         [:div.notes
          [:p
...
(def branta
  (chart 78 1 "Grade 1" "/charts/branta" "Branta" "/composers/tom-richards"
         ...
         "/previews/branta.preview.pdf" "Branta"
         "Branta"
         [:div.notes
          [:p
...
(def moatfield-shuffle
  (chart 79 1 "Grade 1" "/charts/moatfield-shuffle" "Moatfield Shuffle" "/composers/tom-richards"
         ...
         "/previews/moatfield-shuffle.preview.pdf" "Moatfield%20Shuffle"
         "Moatfield%20Shuffle"
         [:div.notes
          [:p
...
(def blue-heron
  (chart 84 1 "Grade 1" "/charts/blue-heron" "Blue Heron" "/composers/christian-overton"
         ...
         "/previews/blue-heron.preview.pdf" "Blue%20Heron"
         "Blue%20Heron"
         [:div.notes
          [:p
...
(def detective-story
  (chart 7 2 "Grade 2" "/charts/detective-story" "Detective Story" "/composers/christian-overton"
         ...
         "/previews/detective-story.preview.pdf" "Detective%20Story"
         "Detective%20Story"
         [:div.notes
          [:p
...
(def that-look
  (chart 9 2 "Grade 2" "/charts/that-look" "That Look" "/composers/christian-overton"
         ...
         "/previews/that-look.preview.pdf" "That%20Look"
         "That%20Look"
         [:div.notes
          [:p
...
(def atlantic-crossing
  (chart 10 2 "Grade 2" "/charts/atlantic-crossing" "Atlantic Crossing" "/composers/christian-overton"
         ...
         "/previews/atlantic-crossing.preview.pdf" "Atlantic%20Crossing"
         "Atlantic%20Crossing"
         [:div.notes
          [:p
...
(def electros-next-plot-jr
  (chart 15 2 "Grade 2" "/charts/electros-next-plot-jr" "Electro's Next Plot (Jr.)" "/composers/christian-overton"
         ...
         "/previews/electros-next-plot-jr.preview.pdf" "Electro's%20Next%20Plot%20(Jr.)"
         "Electro's%20Next%20Plot%20(Jr.)"
         [:div.notes
          [:p
...
(def a-kingdoms-last-hope-jr
  (chart 31 2 "Grade 2" "/charts/a-kingdoms-last-hope-jr" "A Kingdom's Last Hope Jr." "/composers/christian-overton"
         ...
         "/previews/a-kingdoms-last-hope-jr.preview.pdf" "A%20Kingdom's%20Last%20Hope%20Jr."
         "A%20Kingdom's%20Last%20Hope%20Jr."
         [:div.notes
          [:p
...
(def cloud-song
  (chart 49 2 "Grade 2" "/charts/cloud-song" "Cloud Song" "/composers/christian-overton"
         ...
         "/previews/cloud-song.preview.pdf" "Cloud%20Song"
         "Cloud%20Song"
         [:div.notes
          [:p
...
(def let-me-be
  (chart 52 2 "Grade 2" "/charts/let-me-be" "Let Me Be the Sugar in Your Tea" "/composers/christian-overton"
         ...
         "/previews/let-me-be.preview.pdf" "Let%20Me%20Be%20the%20Sugar%20in%20Your%20Tea"
         "Let%20Me%20Be%20the%20Sugar%20in%20Your%20Tea"
         [:div.notes
          [:p
...
(def lifted
  (chart 54 2 "Grade 2" "/charts/lifted" "Lifted" "/composers/christian-overton"
         ...
         "/previews/lifted.preview.pdf" "Lifted"
         "Lifted"
         [:div.notes
          [:p
...
(def a-long-kept-secret
  (chart 64 2 "Grade 2" "/charts/a-long-kept-secret" "A Long Kept Secret" "/composers/christian-overton"
         ...
         "/previews/a-long-kept-secret.preview.pdf" "A%20Long%20Kept%20Secret"
         "A%20Long%20Kept%20Secret"
         [:div.notes
          [:p
...
(def crusin-at-30000
  (chart 66 2 "Grade 2" "/charts/crusin-at-30000" "Crusin' at 30000" "/composers/christian-overton"
         ...
         "/previews/crusin-at-30000.preview.pdf" "Crusin'%20at%2030000"
         "Crusin'%20at%2030000"
         [:div.notes
          [:p
...
(def the-gene-machine
  (chart 67 2 "Grade 2" "/charts/the-gene-machine" "The Gene Machine" "/composers/christian-overton"
         ...
         "/previews/the-gene-machine.preview.pdf" "The%20Gene%20Machine"
         "The%20Gene%20Machine"
         [:div.notes
          [:p
...
(def go-go-blues
  (chart 68 2 "Grade 2" "/charts/go-go-blues" "Go Go Blues" "/composers/christian-overton"
         ...
         "/previews/go-go-blues.preview.pdf" "Go%20Go%20Blues"
         "Go%20Go%20Blues"
         [:div.notes
          [:p
...
(def en-su-camino
  (chart 71 2 "Grade 2" "/charts/en-su-camino" "En Su Camino" "/composers/greg-crowe"
         ...
         "/previews/en-su-camino.preview.pdf" "En%20Su%20Camino"
         "En%20Su%20Camino"
         [:div.notes
          [:p
...
(def sometimes-i-feel
  (chart 72 2 "Grade 2" "/charts/sometimes-i-feel" "Sometimes I Feel Like a Muppet" "/composers/chris-hunt"
         ...
         "/previews/sometimes-i-feel.preview.pdf" "Sometimes%20I%20Feel%20Like%20a%20Muppet"
         "Sometimes%20I%20Feel%20Like%20a%20Muppet"
         [:div.notes
          [:p
...
(def friday-night-special
  (chart 73 2 "Grade 2" "/charts/friday-night-special" "Friday Night Special" "/composers/christian-overton"
         ...
         "/previews/friday-night-special.preview.pdf" "Friday%20Night%20Special"
         "Friday%20Night%20Special"
         [:div.notes
          [:p
...
(def god-rest-ye
  (chart 74 1 "Grade 2" "/charts/god-rest-ye" "God Rest Ye Merry Gentlemen" "/composers/christian-overton"
         ...
         "/previews/god-rest-ye.preview.pdf" "God%20Rest%20Ye%20Merry%20Gentlemen"
         "God%20Rest%20Ye%20Merry%20Gentlemen"
         [:div.notes
          [:p
...
(def the-first-noel
  (chart 86 2 "Grade 2" "/charts/the-first-noel" "The First Noel" "/composers/christian-overton"
         ...
         "/previews/the-first-noel.preview.pdf" "The%20First%20Noel"
         "The%20First%20Noel"
         [:div.notes
          [:p
...
(def what-once-was
  (chart 87 2 "Grade 2" "/charts/what-once-was" "What Once Was" "/composers/christian-overton"
         ...
         "/previews/what-once-was.preview.pdf" "What%20Once%20Was"
         "What%20Once%20Was"
         [:div.notes
          [:p
...
(def brown-and-tan
  (chart 88 2 "Grade 2" "/charts/brown-and-tan" "Brown and Tan" "/composers/brad-harrison"
         ...
         "/previews/brown-and-tan.preview.pdf" "Brown%20and%20Tan"
         "Brown%20and%20Tan"
         [:div.notes
          [:p
...
(def livvy-dear
  (chart 90 2 "Grade 2" "/charts/livvy-dear" "Livvy Dear" "/composers/greg-crowe"
         ...
         "/previews/livvy-dear.preview.pdf" "Livvy%20Dear"
         "Livvy%20Dear"
         [:div.notes
          [:p
...
(def summer-on-my-mind
  (chart 92 2 "Grade 2" "/charts/summer-on-my-mind" "Summer on my Mind" "/composers/tom-richards"
         ...
         "/previews/summer-on-my-mind.preview.pdf" "Summer%20on%20my%20Mind"
         "Summer%20on%20my%20Mind"
         [:div.notes
          [:p
...
(def good-king-w
  (chart 93 2 "Grade 2" "/charts/good-king-w" "Good King Wenceslas" "/composers/christian-overton"
         ...
         "/previews/good-king-w.preview.pdf" "Good%20King%20Wenceslas"
         "Good%20King%20Wenceslas"
         [:div.notes
          [:p
...
(def no-trespassing
  (chart 95 2 "Grade 2" "/charts/no-trespassing" "No Trespassing" "/composers/christian-overton"
         ...
         "/previews/no-trespassing.preview.pdf" "No%20Trespassing"
         "No%20Trespassing"
         [:div.notes
          [:p
...
(def roscos-big-hit
  (chart 107 2 "Grade 2" "/charts/roscos-big-hit" "Rosco's Big Hit" "/composers/tom-richards"
         ...
         "/previews/roscos-big-hit.preview.pdf" "Rosco's%20Big%20Hit"
         "Rosco's%20Big%20Hit"
         [:div.notes
          [:p
...
(def the-long-way-home
  (chart 108 2 "Grade 2" "/charts/the-long-way-home" "The Long Way Home" "/composers/brad-harrison"
         ...
         "/previews/the-long-way-home.preview.pdf" "The%20Long%20Way%20Home"
         "The%20Long%20Way%20Home"
         [:div.notes
          [:p
...
(def the-pursuit
  (chart 3 3 "Grade 3" "/charts/the-pursuit" "The Pursuit" "/composers/christian-overton"
         ...
         "/previews/the-pursuit.preview.pdf" "The%20Pursuit"
         "The%20Pursuit"
         [:div.notes
          [:p
...
(def the-dirrty-dog
  (chart 8 3 "Grade 3" "/charts/the-dirrty-dog" "The Dirrty Dog" "/composers/chris-hunt"
         ...
         "/previews/the-dirrty-dog.preview.pdf" "The%20Dirrty%20Dog"
         "The%20Dirrty%20Dog"
         [:div.notes
          [:p
...
(def on-the-ending-earth
  (chart 12 3 "Grade 3" "/charts/on-the-ending-earth" "On The Ending Earth" "/composers/erik-patterson"
         ...
         "/previews/on-the-ending-earth.preview.pdf" "On%20The%20Ending%20Earth"
         "On%20The%20Ending%20Earth"
         [:div.notes
          [:p
...
(def four-more-to-go
  (chart 13 3 "Grade 3" "/charts/four-more-to-go" "Four More to Go" "/composers/allison-au"
         ...
         "/previews/four-more-to-go.preview.pdf" "Four%20More%20to%20Go"
         "Four%20More%20to%20Go"
         [:div.notes
          [:p
...
(def yun-gia
  (chart 14 3 "Grade 3" "/charts/yun-gia" "Yun Gia" "/composers/christian-overton"
         ...
         "/previews/yun-gia.preview.pdf" "Yun%20Gia"
         "Yun%20Gia"
         [:div.notes
          [:p
...
(def the-green-blues
  (chart 33 3 "Grade 3" "/charts/the-green-blues" "The Green Blues" "/composers/christian-overton"
         ...
         "/previews/the-green-blues.preview.pdf" "The%20Green%20Blues"
         "The%20Green%20Blues"
         [:div.notes
          [:p
...
(def arcadian-autumn
  (chart 34 3 "Grade 3" "/charts/arcadian-autumn" "Arcadian Autumn" "/composers/christian-overton"
         ...
         "/previews/arcadian-autumn.preview.pdf" "Arcadian%20Autumn"
         "Arcadian%20Autumn"
         [:div.notes
          [:p
...
(def sol-fiesta
  (chart 39 3 "Grade 3" "/charts/sol-fiesta" "Sol Fiesta" "/composers/maria-kundakcioglu"
         ...
         "/previews/sol-fiesta.preview.pdf" "Sol%20Fiesta"
         "Sol%20Fiesta"
         [:div.notes
          [:p
...
(def tumbadora
  (chart 40 3 "Grade 3" "/charts/tumbadora" "Tumbadora" "/composers/maria-kundakcioglu"
         ...
         "/previews/tumbadora.preview.pdf" "Tumbadora"
         "Tumbadora"
         [:div.notes
          [:p
...
(def silent-night
  (chart 46 3 "Grade 3" "/charts/silent-night" "Silent Night" "/composers/christian-overton"
         ...
         "/previews/silent-night.preview.pdf" "Silent%20Night"
         "Silent%20Night"
         [:div.notes
          [:p
...
(def joy-to-the-world
  (chart 47 3 "Grade 3" "/charts/joy-to-the-world" "Joy to the World" "/composers/christian-overton"
         ...
         "/previews/joy-to-the-world.preview.pdf" "Joy%20to%20the%20World"
         "Joy%20to%20the%20World"
         [:div.notes
          [:p
...
(def canal-street-walk
  (chart 48 3 "Grade 3" "/charts/canal-street-walk" "Canal Street Walk" "/composers/christian-overton"
         ...
         "/previews/canal-street-walk.preview.pdf" "Canal%20Street%20Walk"
         "Canal%20Street%20Walk"
         [:div.notes
          [:p
...
(def the-dancehall-shake
  (chart 50 3 "Grade 3" "/charts/the-dancehall-shake" "The Dancehall Shake" "/composers/christian-overton"
         ...
         "/previews/the-dancehall-shake.preview.pdf" "The%20Dancehall%20Shake"
         "The%20Dancehall%20Shake"
         [:div.notes
          [:p
...
(def femis-flight
  (chart 51 3 "Grade 3" "/charts/femis-flight" "Femi's Flight" "/composers/christian-overton"
         ...
         "/previews/femis-flight.preview.pdf" "Femi's%20Flight"
         "Femi's%20Flight"
         [:div.notes
          [:p
...
(def lost-stories
  (chart 55 3 "Grade 3" "/charts/lost-stories" "Lost Stories" "/composers/christian-overton"
         ...
         "/previews/lost-stories.preview.pdf" "Lost%20Stories"
         "Lost%20Stories"
         [:div.notes
          [:p
...
(def dark-matter
  (chart 56 3 "Grade 3" "/charts/dark-matter" "Dark Matter" "/composers/andy-ballantyne"
         ...
         "/previews/dark-matter.preview.pdf" "Dark%20Matter"
         "Dark%20Matter"
         [:div.notes
          [:p
...
(def the-wiggle
  (chart 58 3 "Grade 3" "/charts/the-wiggle" "The Wiggle" "/composers/josh-grossman"
         ...
         "/previews/the-wiggle.preview.pdf" "The%20Wiggle"
         "The%20Wiggle"
         [:div.notes
          [:p
...
(def the-test
  (chart 69 3 "Grade 3" "/charts/the-test" "The Test" "/composers/christian-overton"
         ...
         "/previews/the-test.preview.pdf" "The%20Test"
         "The%20Test"
         [:div.notes
          [:p
...
(def el-castor-loco
  (chart 70 3 "Grade 3" "/charts/el-castor-loco" "El Castor Loco" "/composers/andy-ballantyne"
         ...
         "/previews/el-castor-loco.preview.pdf" "El%20Castor%20Loco"
         "El%20Castor%20Loco"
         [:div.notes
          [:p
...
(def the-phantom
  (chart 77 3 "Grade 3" "/charts/the-phantom" "The Phantom" "/composers/jason-logue"
         ...
         "/previews/the-phantom.preview.pdf" "The%20Phantom"
         "The%20Phantom"
         [:div.notes
          [:p
...
(def don-carlos-dream
  (chart 83 3 "Grade 3" "/charts/don-carlos-dream" "Don Carlos' Dream" "/composers/ewan-divitt"
         ...
         "/previews/don-carlos-dream.preview.pdf" "Don%20Carlos'%20Dream"
         "Don%20Carlos'%20Dream"
         [:div.notes
          [:p
...
(def hamunaptra
  (chart 85 3 "Grade 3" "/charts/hamunaptra" "Hamunaptra" "/composers/christian-overton"
         ...
         "/previews/hamunaptra.preview.pdf" "Hamunaptra"
         "Hamunaptra"
         [:div.notes
          [:p
...
(def introduccion
  (chart 94 3 "Grade 3" "/charts/introduccion" "Introduccion" "/composers/christian-overton"
         ...
         "/previews/introduccion.preview.pdf" "Introduccion"
         "Introduccion"
         [:div.notes
          [:p
...
(def midnight-clear
  (chart 101 3 "Grade 3" "/charts/midnight-clear" "It Came Upon a Midnight Clear" "/composers/christian-overton"
         ...
         "/previews/midnight-clear.preview.pdf" "It%20Came%20Upon%20a%20Midnight%20Clear"
         "It%20Came%20Upon%20a%20Midnight%20Clear"
         [:div.notes
          [:p
...
(def life-race
  (chart 102 3 "Grade 3" "/charts/life-race" "Life Race" "/composers/christian-overton"
         ...
         "/previews/life-race.preview.pdf" "Life%20Race"
         "Life%20Race"
         [:div.notes
          [:p
...
(def junk
  (chart 103 3 "Grade 3" "/charts/junk" "Junk" "/composers/liam-gallagher"
         ...
         "/previews/junk.preview.pdf" "Junk"
         "Junk"
         [:div.notes
          [:p
...
(def la-maquina
  (chart 104 3 "Grade 3" "/charts/la-maquina" "La Maquina" "/composers/greg-crowe"
         ...
         "/previews/la-maquina.preview.pdf" "La%20Maquina"
         "La%20Maquina"
         [:div.notes
          [:p
...
(def last-resorts
  (chart 105 3 "Grade 3" "/charts/last-resorts" "Last Resorts" "/composers/chelsea-mcbride"
         ...
         "/previews/last-resorts.preview.pdf" "Last%20Resorts"
         "Last%20Resorts"
         [:div.notes
          [:p
...
(def mad-man-mambo
  (chart 106 3 "Grade 3" "/charts/mad-man-mambo" "Mad Man Mambo" "/composers/jason-logue"
         ...
         "/previews/mad-man-mambo.preview.pdf" "Mad%20Man%20Mambo"
         "Mad%20Man%20Mambo"
         [:div.notes
          [:p
...
(def two-dave-k
  (chart 16 4 "Grade 4" "/charts/2-dave-k" "2 Dave K" "/composers/christian-overton"
         ...
         "/previews/2-dave-k.preview.pdf" "2%20Dave%20K"
         "2%20Dave%20K"
         [:div.notes
          [:p
...
(def a-kingdoms-last-hope
  (chart 17 4 "Grade 4" "/charts/a-kingdoms-last-hope" "A Kingdom's Last Hope" "/composers/christian-overton"
         ...
         "/previews/a-kingdoms-last-hope.preview.pdf" "A%20Kingdom's%20Last%20Hope"
         "A%20Kingdom's%20Last%20Hope"
         [:div.notes
          [:p
...
(def ten-41-am
  (chart 18 4 "Grade 4" "/charts/10-41-am" "10:41AM" "/composers/christian-overton"
         ...
         "/previews/10-41-am.preview.pdf" "10%3A41AM"
         "10%3A41AM"
         [:div.notes
          [:p
...
(def wood-and-shadow
  (chart 19 4 "Grade 4" "/charts/wood-and-shadow" "Wood & Shadow" "/composers/christian-overton"
         ...
         "/previews/wood-and-shadow.preview.pdf" "Wood%20%26%20Shadow"
         "Wood%20%26%20Shadow"
         [:div.notes
          [:p
...
(def electros-next-plot
  (chart 20 4 "Grade 4" "/charts/electros-next-plot" "Electro's Next Plot " "/composers/christian-overton"
         ...
         "/previews/electros-next-plot.preview.pdf" "Electro's%20Next%20Plot%20"
         "Electro's%20Next%20Plot%20"
         [:div.notes
          [:p
...
(def chazz
  (chart 21 4 "Grade 4" "/charts/chazz" "Chazz" "/composers/josh-grossman"
         ...
         "/previews/chazz.preview.pdf" "Chazz"
         "Chazz"
         [:div.notes
          [:p
...
(def amazing-grace
  (chart 22 4 "Grade 4" "/charts/amazing-grace" "Amazing Grace" "/composers/josh-grossman"
         ...
         "/previews/amazing-grace.preview.pdf" "Amazing%20Grace"
         "Amazing%20Grace"
         [:div.notes
          [:p
...
(def the-path
  (chart 23 4 "Grade 4" "/charts/the-path" "The Path" "/composers/josh-grossman"
         ...
         "/previews/the-path.preview.pdf" "The%20Path"
         "The%20Path"
         [:div.notes
          [:p
...
(def the-phone-dont-ring-jack
  (chart 25 4 "Grade 4" "/charts/the-phone-dont-ring-jack" "The Phone Don't Ring Jack" "/composers/andy-ballantyne"
         ...
         "/previews/the-phone-dont-ring-jack.preview.pdf" "The%20Phone%20Don't%20Ring%20Jack"
         "The%20Phone%20Don't%20Ring%20Jack"
         [:div.notes
          [:p
...
(def first-x-free
  (chart 26 4 "Grade 4" "/charts/first-x-free" "First X Free" "/composers/chris-hunt"
         ...
         "/previews/first-x-free.preview.pdf" "First%20X%20Free"
         "First%20X%20Free"
         [:div.notes
          [:p
...
(def funk-out
  (chart 38 4 "Grade 4" "/charts/funk-out" "Funk Out" "/composers/michael-kundakcioglu"
         ...
         "/previews/funk-out.preview.pdf" "Funk%20Out"
         "Funk%20Out"
         [:div.notes
          [:p
...
(def vista
  (chart 41 4 "Grade 4" "/charts/vista" "Vista" "/composers/andy-ballantyne"
         ...
         "/previews/vista.preview.pdf" "Vista"
         "Vista"
         [:div.notes
          [:p
...
(def the-fifth-beatle
  (chart 57 4 "Grade 4" "/charts/the-fifth-beatle" "The Fifth Beatle" "/composers/andy-ballantyne"
         ...
         "/previews/the-fifth-beatle.preview.pdf" "The%20Fifth%20Beatle"
         "The%20Fifth%20Beatle"
         [:div.notes
          [:p
...
(def this-buts-for-you
  (chart 62 4 "Grade 4" "/charts/this-buts-for-you" "This But's for You!" "/composers/terry-promane"
         ...
         "/previews/this-buts-for-you.preview.pdf" "This%20But's%20for%20You!"
         "This%20But's%20for%20You!"
         [:div.notes
          [:p
...
(def surface-tension
  (chart 63 4 "Grade 4" "/charts/surface-tension" "Surface Tension" "/composers/jim-lewis"
         ...
         "/previews/surface-tension.preview.pdf" "Surface%20Tension"
         "Surface%20Tension"
         [:div.notes
          [:p
...
(def santiago-nights
  (chart 80 4 "Grade 4" "/charts/santiago-nights" "Santiago Nights" "/composers/jason-logue"
         ...
         "/previews/santiago-nights.preview.pdf" "Santiago%20Nights"
         "Santiago%20Nights"
         [:div.notes
          [:p
...
(def epitaph
  (chart 81 4 "Grade 4" "/charts/epitaph" "Epitaph" "/composers/andy-ballantyne"
         ...
         "/previews/epitaph.preview.pdf" "Epitaph"
         "Epitaph"
         [:div.notes
          [:p
...
(def song-for-l
  (chart 91 4 "Grade 4" "/charts/song-for-l" "Song For L" "/composers/brad-cheeseman"
         ...
         "/previews/song-for-l.preview.pdf" "Song%20For%20L"
         "Song%20For%20L"
         [:div.notes
          [:p
...
(def state-of-mind
  (chart 96 4 "Grade 4" "/charts/state-of-mind" "State of Mind" "/composers/chelsea-mcbride"
         ...
         "/previews/state-of-mind.preview.pdf" "State%20of%20Mind"
         "State%20of%20Mind"
         [:div.notes
          [:p
...
(def state-of-mind-reprise
  (chart 97 4 "Grade 4" "/charts/state-of-mind-reprise" "State of Mind Reprise" "/composers/chelsea-mcbride"
         ...
         "/previews/state-of-mind-reprise.preview.pdf" "State%20of%20Mind%20Reprise"
         "State%20of%20Mind%20Reprise"
         [:div.notes
          [:p
...
(def river
  (chart 98 4 "Grade 4" "/charts/river" "River" "/composers/chelsea-mcbride"
         ...
         "/previews/river.preview.pdf" "River"
         "River"
         [:div.notes
          [:p
...
(def julia
  (chart 99 4 "Grade 4" "/charts/julia" "Julia" "/composers/chelsea-mcbride"
         ...
         "/previews/julia.preview.pdf" "Julia"
         "Julia"
         [:div.notes
          [:p
...
(def thinking-in-circles
  (chart 100 4 "Grade 4" "/charts/thinking-in-circles" "Thinking In Circles" "/composers/chelsea-mcbride"
         ...
         "/previews/thinking-in-circles.preview.pdf" "Thinking%20In%20Circles"
         "Thinking%20In%20Circles"
         [:div.notes
          [:p
...
(def ambleside
  (chart 109 4 "Grade 4" "/charts/ambleside" "Ambleside" "/composers/chelsea-mcbride"
         ...
         "/previews/ambleside.preview.pdf" "Ambleside"
         "Ambleside"
         [:div.notes
          [:p
...
(def intransitory
  (chart 110 4 "Grade 4" "/charts/intransitory" "Intransitory" "/composers/chelsea-mcbride"
         ...
         "/previews/intransitory.preview.pdf" "Intransitory"
         "Intransitory"
         [:div.notes
          [:p
...
(def twilight-fall
  (chart 111 4 "Grade 4" "/charts/twilight-fall" "The Twilight Fall" "/composers/chelsea-mcbride"
         ...
         "/previews/twilight-fall.preview.pdf" "The%20Twilight%20Fall"
         "The%20Twilight%20Fall"
         [:div.notes
          [:p
...
(def smooth
  (chart 112 4 "Grade 4" "/charts/smooth" "Smooth" "/composers/chelsea-mcbride"
         ...
         "/previews/smooth.preview.pdf" "Smooth"
         "Smooth"
         [:div.notes
          [:p
...
(def spirits
  (chart 113 4 "Grade 4" "/charts/spirits" "Spirits" "/composers/chelsea-mcbride"
         ...
         "/previews/spirits.preview.pdf" "Spirits"
         "Spirits"
         [:div.notes
          [:p
...
(def arrival-of-the-pegasus
  (chart 114 4 "Grade 4" "/charts/arrival-of-the-pegasus" "Arrival of the Pegasus" "/composers/chelsea-mcbride"
         ...
         "/previews/arrival-of-the-pegasus.preview.pdf" "Arrival%20of%20the%20Pegasus"
         "Arrival%20of%20the%20Pegasus"
         [:div.notes
          [:p
...
(def foot-in-mouth
  (chart 115 4 "Grade 4" "/charts/foot-in-mouth" "Foot in Mouth" "/composers/chelsea-mcbride"
         ...
         "/previews/foot-in-mouth.preview.pdf" "Foot%20in%20Mouth"
         "Foot%20in%20Mouth"
         [:div.notes
          [:p
...
(def in-dreams
  (chart 116 4 "Grade 4" "/charts/in-dreams" "In Dreams" "/composers/chelsea-mcbride"
         ...
         "/previews/in-dreams.preview.pdf" "In%20Dreams"
         "In%20Dreams"
         [:div.notes
          [:p
...
(def ambleside-reprise
  (chart 117 4 "Grade 4" "/charts/ambleside-reprise" "Ambleside (Reprise)" "/composers/chelsea-mcbride"
         ...
         "/previews/ambleside-reprise.preview.pdf" "Ambleside%20(Reprise)"
         "Ambleside%20(Reprise)"
         [:div.notes
          [:p
...
(def something-simple
  (chart 118 4 "Grade 4" "/charts/something-simple" "Something Simple" "/composers/chelsea-mcbride"
         ...
         "/previews/something-simple.preview.pdf" "Something%20Simple"
         "Something%20Simple"
         [:div.notes
          [:p
...
(def a-cool-breeze
  (chart 119 4 "Grade 4" "/charts/a-cool-breeze" "A Cool Breeze" "/composers/terry-promane"
         ...
         "/previews/a-cool-breeze.preview.pdf" "A%20Cool%20Breeze"
         "A%20Cool%20Breeze"
         [:div.notes
          [:p
