...
(def html-charts-let-me-be-the-sugar-in-your-tea
 [:html
  {:lang "en-us"}
  [:head
   [:title "Let Me Be the Sugar in Your Tea - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#52.chart.grade2
       [:div.head
        [:h2.title
         [:a
          {:href "/charts/let-me-be-the-sugar-in-your-tea"}
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio52.audio
           {:href "/audio/let-me-be-the-sugar-in-your-tea.mp3"}
           "▶   Listen\n"]]
         [:li
          [:a
           {:href
            "/previews/let-me-be-the-sugar-in-your-tea.preview.pdf",
            :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
...
(defn show-html-charts-let-me-be-the-sugar-in-your-tea [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-let-me-be-the-sugar-in-your-tea)})
