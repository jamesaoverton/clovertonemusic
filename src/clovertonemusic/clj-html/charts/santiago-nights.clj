...
(def html-charts-santiago-nights
 [:html
  {:lang "en-us"}
  [:head
   [:title "Santiago Nights - Clovertone Music"]
   [:meta
...
(defn show-html-charts-santiago-nights [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-santiago-nights)})
