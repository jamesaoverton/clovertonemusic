...
(def html-charts-moatfield-shuffle
 [:html
  {:lang "en-us"}
  [:head
   [:title "Moatfield Shuffle - Clovertone Music"]
   [:meta
...
(defn show-html-charts-moatfield-shuffle [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-moatfield-shuffle)})
