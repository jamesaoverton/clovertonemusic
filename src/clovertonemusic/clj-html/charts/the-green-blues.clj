...
(def html-charts-the-green-blues
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Green Blues - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-green-blues [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-green-blues)})
