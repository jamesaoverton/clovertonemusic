...
(def html-charts-the-fifth-beatle
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Fifth Beatle - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-fifth-beatle [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-fifth-beatle)})
