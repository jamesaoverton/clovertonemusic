...
(def html-charts-roscos-big-hit
 [:html
  {:lang "en-us"}
  [:head
   [:title "Rosco's Big Hit - Clovertone Music"]
   [:meta
...
(defn show-html-charts-roscos-big-hit [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-roscos-big-hit)})
