...
(def html-charts-no-trespassing
 [:html
  {:lang "en-us"}
  [:head
   [:title "No Trespassing - Clovertone Music"]
   [:meta
...
(defn show-html-charts-no-trespassing [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-no-trespassing)})
