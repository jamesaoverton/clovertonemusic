...
(def html-charts-summer-on-my-mind
 [:html
  {:lang "en-us"}
  [:head
   [:title "Summer on my Mind - Clovertone Music"]
   [:meta
...
(defn show-html-charts-summer-on-my-mind [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-summer-on-my-mind)})
