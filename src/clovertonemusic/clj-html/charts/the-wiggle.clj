...
(def html-charts-the-wiggle
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Wiggle - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#58.chart.grade3
       [:div.head
        ...
        [:h3.name
         [:a {:href "/composers/josh-grossman"} "By Josh Grossman\n"]]]
       [:div.body
        [:div.image
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/the-wiggle.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
       ...
       [:table.details
        ...
        [:tbody
         [:tr
          [:td "Jazz Band"]
          [:td "Funk"]
          [:td [:a {:href "/composers/josh-grossman"} "Josh Grossman"]]
          [:td "4:30"]
          [:td "4/4"]
          [:td "100"]]]]]]
     [:div#charts]
...
(defn show-html-charts-the-wiggle [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-wiggle)})
