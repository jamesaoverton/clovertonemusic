...
(def html-charts-livvy-dear
 [:html
  {:lang "en-us"}
  [:head
   [:title "Livvy Dear - Clovertone Music"]
   [:meta
      ...
      [:div#90.chart.grade2
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/livvy-dear.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-livvy-dear [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-livvy-dear)})
