...
(def html-charts-state-of-mind-reprise
 [:html
  {:lang "en-us"}
  [:head
   [:title "State of Mind Reprise - Clovertone Music"]
   [:meta
...
(defn show-html-charts-state-of-mind-reprise [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-state-of-mind-reprise)})
