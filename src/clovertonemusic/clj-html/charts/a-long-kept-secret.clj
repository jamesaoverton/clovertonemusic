...
(def html-charts-a-long-kept-secret
 [:html
  {:lang "en-us"}
  [:head
   [:title "A Long Kept Secret - Clovertone Music"]
   [:meta
...
(defn show-html-charts-a-long-kept-secret [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-a-long-kept-secret)})
