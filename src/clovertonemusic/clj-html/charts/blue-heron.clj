...
(def html-charts-blue-heron
 [:html
  {:lang "en-us"}
  [:head
   [:title "Blue Heron - Clovertone Music"]
   [:meta
      ...
      [:div#84.chart.grade1
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/blue-heron.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-blue-heron [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-blue-heron)})
