...
(def html-charts-this-buts-for-you
 [:html
  {:lang "en-us"}
  [:head
   [:title "This But's for You! - Clovertone Music"]
   [:meta
       ...
       [:div.head
        [:h2.title
         [:a
          ...
          "This But's for You!"]]
        [:h3.name
         [:a {:href "/composers/terry-promane"} "By Terry Promane\n"]]]
       [:div.body
        [:div.image
       ...
       [:table.details
        ...
        [:tbody
         [:tr
          [:td "Jazz Band"]
          [:td "Swing"]
          [:td [:a {:href "/composers/terry-promane"} "Terry Promane"]]
          [:td "7:00"]
          [:td "4/4"]
          [:td "160"]]]]]]
     [:div#charts]
...
(defn show-html-charts-this-buts-for-you [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-this-buts-for-you)})
