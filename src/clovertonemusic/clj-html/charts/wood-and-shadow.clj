...
(def html-charts-wood-and-shadow
 [:html
  {:lang "en-us"}
  [:head
   [:title "Wood & Shadow - Clovertone Music"]
   [:meta
...
(defn show-html-charts-wood-and-shadow [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-wood-and-shadow)})
