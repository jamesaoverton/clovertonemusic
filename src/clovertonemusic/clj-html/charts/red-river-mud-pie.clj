...
(def html-charts-red-river-mud-pie
 [:html
  {:lang "en-us"}
  [:head
   [:title "Red River Mud Pie - Clovertone Music"]
   [:meta
...
(defn show-html-charts-red-river-mud-pie [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-red-river-mud-pie)})
