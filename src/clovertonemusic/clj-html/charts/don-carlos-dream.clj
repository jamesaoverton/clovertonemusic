...
(def html-charts-don-carlos-dream
 [:html
  {:lang "en-us"}
  [:head
   [:title "Don Carlos' Dream - Clovertone Music"]
   [:meta
...
(defn show-html-charts-don-carlos-dream [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-don-carlos-dream)})
