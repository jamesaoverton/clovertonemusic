...
(def html-charts-the-gene-machine
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Gene Machine - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-gene-machine [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-gene-machine)})
