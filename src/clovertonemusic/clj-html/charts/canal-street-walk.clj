...
(def html-charts-canal-street-walk
 [:html
  {:lang "en-us"}
  [:head
   [:title "Canal Street Walk - Clovertone Music"]
   [:meta
...
(defn show-html-charts-canal-street-walk [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-canal-street-walk)})
