...
(def html-charts-a-kingdoms-last-hope-jr
 [:html
  {:lang "en-us"}
  [:head
   [:title "A Kingdom's Last Hope Jr. - Clovertone Music"]
   [:meta
...
(defn show-html-charts-a-kingdoms-last-hope-jr [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-a-kingdoms-last-hope-jr)})
