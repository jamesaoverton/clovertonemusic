      ...
      [:div#61.chart.grade1
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/la-cattura.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-la-cattura [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-la-cattura)})
