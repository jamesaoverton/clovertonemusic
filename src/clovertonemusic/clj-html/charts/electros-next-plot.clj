...
(def html-charts-electros-next-plot
 [:html
  {:lang "en-us"}
  [:head
   [:title "Electro's Next Plot  - Clovertone Music"]
   [:meta
...
(defn show-html-charts-electros-next-plot [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-electros-next-plot)})
