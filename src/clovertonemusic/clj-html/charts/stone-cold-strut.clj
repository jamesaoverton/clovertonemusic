...
(def html-charts-stone-cold-strut
 [:html
  {:lang "en-us"}
  [:head
   [:title "Stone Cold Strut - Clovertone Music"]
   [:meta
...
(defn show-html-charts-stone-cold-strut [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-stone-cold-strut)})
