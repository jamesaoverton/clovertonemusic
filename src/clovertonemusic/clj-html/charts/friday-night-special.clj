...
(def html-charts-friday-night-special
 [:html
  {:lang "en-us"}
  [:head
   [:title "Friday Night Special - Clovertone Music"]
   [:meta
...
(defn show-html-charts-friday-night-special [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-friday-night-special)})
