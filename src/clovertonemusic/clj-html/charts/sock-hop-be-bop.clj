...
(def html-charts-sock-hop-be-bop
 [:html
  {:lang "en-us"}
  [:head
   [:title "Sock Hop Be-Bop - Clovertone Music"]
   [:meta
...
(defn show-html-charts-sock-hop-be-bop [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-sock-hop-be-bop)})
