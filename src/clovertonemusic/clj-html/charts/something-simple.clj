...
(def html-charts-something-simple
 [:html
  {:lang "en-us"}
  [:head
   [:title "Something Simple - Clovertone Music"]
   [:meta
...
(defn show-html-charts-something-simple [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-something-simple)})
