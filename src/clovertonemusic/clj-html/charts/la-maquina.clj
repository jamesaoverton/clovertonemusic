...
(def html-charts-la-maquina
 [:html
  {:lang "en-us"}
  [:head
   [:title "La Maquina - Clovertone Music"]
   [:meta
      ...
      [:div#104.chart.grade3
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/la-maquina.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-la-maquina [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-la-maquina)})
