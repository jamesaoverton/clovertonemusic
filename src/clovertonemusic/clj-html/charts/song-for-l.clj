...
(def html-charts-song-for-l
 [:html
  {:lang "en-us"}
  [:head
   [:title "Song For L - Clovertone Music"]
   [:meta
      ...
      [:div#91.chart.grade4
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/song-for-l.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-song-for-l [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-song-for-l)})
