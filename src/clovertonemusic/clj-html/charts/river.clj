...
(def html-charts-river
 [:html
  {:lang "en-us"}
  [:head
   [:title "River - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#98.chart.grade4
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio98.audio {:href "/audio/river.mp3"} "▶   Listen\n"]]
         [:li
          [:a
...
(defn show-html-charts-river [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-river)})
