...
(def html-charts-the-long-way-home
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Long Way Home - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#108.chart.grade2
       [:div.head
        ...
        [:h3.name
         [:a {:href "/composers/brad-harrison"} "By Brad Harrison\n"]]]
       [:div.body
        [:div.image
       ...
       [:table.details
        ...
        [:tbody
         [:tr
          [:td "Jazz Band"]
          [:td "Rock Ballad"]
          [:td [:a {:href "/composers/brad-harrison"} "Brad Harrison"]]
          [:td "4:00"]
          [:td "4/4"]
          [:td "100"]]]]]]
     [:div#charts]
...
(defn show-html-charts-the-long-way-home [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-long-way-home)})
