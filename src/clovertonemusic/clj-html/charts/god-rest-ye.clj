...
(def html-charts-god-rest-ye
 [:html
  {:lang "en-us"}
  [:head
   [:title "God Rest Ye Merry Gentlemen - Clovertone Music"]
   [:meta
...
(defn show-html-charts-god-rest-ye [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-god-rest-ye)})
