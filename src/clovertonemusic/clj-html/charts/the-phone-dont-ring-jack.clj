...
(def html-charts-the-phone-dont-ring-jack
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Phone Don't Ring Jack - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-phone-dont-ring-jack [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-phone-dont-ring-jack)})
