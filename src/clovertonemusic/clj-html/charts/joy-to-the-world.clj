...
(def html-charts-joy-to-the-world
 [:html
  {:lang "en-us"}
  [:head
   [:title "Joy to the World - Clovertone Music"]
   [:meta
...
(defn show-html-charts-joy-to-the-world [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-joy-to-the-world)})
