...
(def html-charts-twilight-fall
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Twilight Fall - Clovertone Music"]
   [:meta
...
(defn show-html-charts-twilight-fall [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-twilight-fall)})
