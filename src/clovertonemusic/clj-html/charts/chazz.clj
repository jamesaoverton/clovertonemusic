...
(def html-charts-chazz
 [:html
  {:lang "en-us"}
  [:head
   [:title "Chazz - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#21.chart.grade4
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio21.audio {:href "/audio/chazz.mp3"} "▶   Listen\n"]]
         [:li
          [:a
...
(defn show-html-charts-chazz [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-chazz)})
