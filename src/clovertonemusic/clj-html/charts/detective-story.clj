...
(def html-charts-detective-story
 [:html
  {:lang "en-us"}
  [:head
   [:title "Detective Story - Clovertone Music"]
   [:meta
...
(defn show-html-charts-detective-story [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-detective-story)})
