...
(def html-charts-el-castor-loco
 [:html
  {:lang "en-us"}
  [:head
   [:title "El Castor Loco - Clovertone Music"]
   [:meta
...
(defn show-html-charts-el-castor-loco [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-el-castor-loco)})
