...
(def html-charts-four-more-to-go
 [:html
  {:lang "en-us"}
  [:head
   [:title "Four More to Go - Clovertone Music"]
   [:meta
...
(defn show-html-charts-four-more-to-go [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-four-more-to-go)})
