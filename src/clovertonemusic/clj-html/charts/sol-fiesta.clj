...
(def html-charts-sol-fiesta
 [:html
  {:lang "en-us"}
  [:head
   [:title "Sol Fiesta - Clovertone Music"]
   [:meta
      ...
      [:div#39.chart.grade3
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/sol-fiesta.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-sol-fiesta [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-sol-fiesta)})
