...
(def html-charts-la-squadra-da-milano
 [:html
  {:lang "en-us"}
  [:head
   [:title "La Squadra Da Milano - Clovertone Music"]
   [:meta
...
(defn show-html-charts-la-squadra-da-milano [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-la-squadra-da-milano)})
