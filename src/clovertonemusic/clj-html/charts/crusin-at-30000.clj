...
(def html-charts-crusin-at-30000
 [:html
  {:lang "en-us"}
  [:head
   [:title "Crusin' at 30000 - Clovertone Music"]
   [:meta
...
(defn show-html-charts-crusin-at-30000 [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-crusin-at-30000)})
