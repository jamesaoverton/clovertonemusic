...
(def html-charts-thinking-in-circles
 [:html
  {:lang "en-us"}
  [:head
   [:title "Thinking In Circles - Clovertone Music"]
   [:meta
...
(defn show-html-charts-thinking-in-circles [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-thinking-in-circles)})
