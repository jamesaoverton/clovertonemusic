...
(def html-charts-midnight-clear
 [:html
  {:lang "en-us"}
  [:head
   [:title "It Came Upon a Midnight Clear - Clovertone Music"]
   [:meta
...
(defn show-html-charts-midnight-clear [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-midnight-clear)})
