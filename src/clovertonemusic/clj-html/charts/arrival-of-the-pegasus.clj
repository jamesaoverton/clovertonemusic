...
(def html-charts-arrival-of-the-pegasus
 [:html
  {:lang "en-us"}
  [:head
   [:title "Arrival of the Pegasus - Clovertone Music"]
   [:meta
...
(defn show-html-charts-arrival-of-the-pegasus [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-arrival-of-the-pegasus)})
