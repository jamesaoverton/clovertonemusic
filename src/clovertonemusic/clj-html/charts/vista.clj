...
(def html-charts-vista
 [:html
  {:lang "en-us"}
  [:head
   [:title "Vista - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#41.chart.grade4
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio41.audio {:href "/audio/vista.mp3"} "▶   Listen\n"]]
         [:li
          [:a
...
(defn show-html-charts-vista [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-vista)})
