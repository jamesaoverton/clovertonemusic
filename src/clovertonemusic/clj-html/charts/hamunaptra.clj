...
(def html-charts-hamunaptra
 [:html
  {:lang "en-us"}
  [:head
   [:title "Hamunaptra - Clovertone Music"]
   [:meta
      ...
      [:div#85.chart.grade3
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/hamunaptra.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-hamunaptra [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-hamunaptra)})
