...
(def html-charts-atlantic-crossing
 [:html
  {:lang "en-us"}
  [:head
   [:title "Atlantic Crossing - Clovertone Music"]
   [:meta
...
(defn show-html-charts-atlantic-crossing [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-atlantic-crossing)})
