...
(def html-charts-the-first-noel
 [:html
  {:lang "en-us"}
  [:head
   [:title "The First Noel - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-first-noel [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-first-noel)})
