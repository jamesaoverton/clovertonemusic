...
(def html-charts-la-cattura-di-salvatore-veloce
 [:html
  {:lang "en-us"}
  [:head
   [:title "La Cattura Di Salvatore Veloce - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#61.chart.grade1
       [:div.head
        [:h2.title
         [:a
          {:href "/charts/la-cattura-di-salvatore-veloce"}
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio61.audio
           {:href "/audio/la-cattura-di-salvatore-veloce.mp3"}
           "▶   Listen\n"]]
         [:li
          [:a
           {:href
            "/previews/la-cattura-di-salvatore-veloce.preview.pdf",
            :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
...
(defn show-html-charts-la-cattura-di-salvatore-veloce [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-la-cattura-di-salvatore-veloce)})
