...
(def html-charts-the-dirrty-dog
 [:html
  {:lang "en-us"}
  [:head
   [:title "The Dirrty Dog - Clovertone Music"]
   [:meta
...
(defn show-html-charts-the-dirrty-dog [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-the-dirrty-dog)})
