...
(def html-charts-junk
 [:html
  {:lang "en-us"}
  [:head
   [:title "Junk - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#103.chart.grade3
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio103.audio {:href "/audio/junk.mp3"} "▶   Listen\n"]]
         [:li
          [:a
...
(defn show-html-charts-junk [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-junk)})
