...
(def html-charts-julia
 [:html
  {:lang "en-us"}
  [:head
   [:title "Julia - Clovertone Music"]
   [:meta
     ...
     [:div#contents
      [:div#99.chart.grade4
       ...
       [:div.body
        ...
        [:ul.actions
         [:li
          [:a#audio99.audio {:href "/audio/julia.mp3"} "▶   Listen\n"]]
         [:li
          [:a
...
(defn show-html-charts-julia [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-julia)})
