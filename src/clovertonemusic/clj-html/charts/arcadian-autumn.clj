...
(def html-charts-arcadian-autumn
 [:html
  {:lang "en-us"}
  [:head
   [:title "Arcadian Autumn - Clovertone Music"]
   [:meta
...
(defn show-html-charts-arcadian-autumn [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-arcadian-autumn)})
