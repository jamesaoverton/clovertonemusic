...
(def html-charts-sometimes-i-feel
 [:html
  {:lang "en-us"}
  [:head
   [:title "Sometimes I Feel Like a Muppet - Clovertone Music"]
   [:meta
...
(defn show-html-charts-sometimes-i-feel [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-sometimes-i-feel)})
