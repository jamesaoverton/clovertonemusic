...
(def html-charts-cowboy-countdown
 [:html
  {:lang "en-us"}
  [:head
   [:title "Cowboy Countdown - Clovertone Music"]
   [:meta
...
(defn show-html-charts-cowboy-countdown [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-cowboy-countdown)})
