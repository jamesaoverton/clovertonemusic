...
(def html-charts-cloud-song
 [:html
  {:lang "en-us"}
  [:head
   [:title "Cloud Song - Clovertone Music"]
   [:meta
      ...
      [:div#49.chart.grade2
       ...
       [:div.body
        ...
        [:ul.actions
         ...
         [:li
          [:a
           {:href "/previews/cloud-song.preview.pdf", :target "_blank"}
           "Preview\n"]]
         [:li
          [:a
           {:href
...
(defn show-html-charts-cloud-song [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-cloud-song)})
