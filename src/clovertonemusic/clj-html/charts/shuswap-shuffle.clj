...
(def html-charts-shuswap-shuffle
 [:html
  {:lang "en-us"}
  [:head
   [:title "Shuswap Shuffle - Clovertone Music"]
   [:meta
...
(defn show-html-charts-shuswap-shuffle [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-shuswap-shuffle)})
