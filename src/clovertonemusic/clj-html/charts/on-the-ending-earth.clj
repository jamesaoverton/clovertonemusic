...
(def html-charts-on-the-ending-earth
 [:html
  {:lang "en-us"}
  [:head
   [:title "On The Ending Earth - Clovertone Music"]
   [:meta
...
(defn show-html-charts-on-the-ending-earth [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-charts-on-the-ending-earth)})
