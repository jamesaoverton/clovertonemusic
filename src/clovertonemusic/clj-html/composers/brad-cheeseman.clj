...
(def html-composers-brad-cheeseman
 [:html
  {:lang "en-us"}
  [:head
   [:title "Brad Cheeseman - Clovertone Music"]
   [:meta
...
(defn show-html-composers-brad-cheeseman [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-composers-brad-cheeseman)})
