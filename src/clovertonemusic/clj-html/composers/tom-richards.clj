...
(def html-composers-tom-richards
 [:html
  {:lang "en-us"}
  [:head
   [:title "Tom Richards - Clovertone Music"]
   [:meta
...
(defn show-html-composers-tom-richards [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-composers-tom-richards)})
