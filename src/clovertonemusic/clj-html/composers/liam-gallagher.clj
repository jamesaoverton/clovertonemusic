...
(def html-composers-liam-gallagher
 [:html
  {:lang "en-us"}
  [:head
   [:title "Liam Gallagher - Clovertone Music"]
   [:meta
...
(defn show-html-composers-liam-gallagher [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-composers-liam-gallagher)})
