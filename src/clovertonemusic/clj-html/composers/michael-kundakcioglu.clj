...
(def html-composers-michael-kundakcioglu
 [:html
  {:lang "en-us"}
  [:head
   [:title "Michael Kundakcioglu - Clovertone Music"]
   [:meta
...
(defn show-html-composers-michael-kundakcioglu [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-composers-michael-kundakcioglu)})
