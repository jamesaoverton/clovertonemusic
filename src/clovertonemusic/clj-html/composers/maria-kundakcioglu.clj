...
(def html-composers-maria-kundakcioglu
 [:html
  {:lang "en-us"}
  [:head
   [:title "Maria Kundakcioglu - Clovertone Music"]
   [:meta
...
(defn show-html-composers-maria-kundakcioglu [request]
  {:status 200
   :headers {"Content-Type" "text/html"}
   :body (page/html html-composers-maria-kundakcioglu)})
